...
if __name__ == "__main__":
    ...
    #experiment(task="graph_classification", dataset="mydataset", model="gcn")
    # Run with given datapaath
    experiment(task="graph_classification", dataset="./data/principles/principles_A.txt", model="gcn")
